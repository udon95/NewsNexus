...
import lhlImage from "../assets/test.png"; // ✅ Rank #1 (LHL Article)
...
const ArticlesRank = () => {
  ...
  return (
    <div className="w-full max-w-5xl mx-auto px-16 font-grotesk">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3 mt-6 max-w-[900px]">
        {articles.map((article) => (
          ...
          >
            ...
            {/* Bottom Divider */}
            <div className="w-full h-0.5 bg-gray-300 mb-4">Article name</div>
          </button>
        ))}
      </div>
    </div>
