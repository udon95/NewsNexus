...
export const PremiumSubmitTest = () => {
  ...
  const feedbackQuestions = [
    ...
    {
      text: "How accessible is the news site for those who are site impaired or have language barriers ?",
      column: "accessible",
    },
    { text: "How is the content safety in the news site ?", column: "safety" },
    {
      text: "How reasonably priced is the news subscription ?",
      column: "price",
    },
    {
      text: "Do you think NewsNexus has good news coverage and well curated news ?",
      column: "news",
    },
  ];
    ...
    <div className="w-full min-h-screen bg-indigo-50 text-black font-grotesk flex justify-center">
      <main className="w-full max-w-4xl p-10 max-md:flex-col gap-6">
        <div className="flex flex-col w-full">
          <h1 className="text-3xl font-bold mb-1">Share Your Experience :</h1>

          <ul className="mb-4 relative">
            {feedbackQuestions.map((question) => (
              <div key={question.column} className="p-2">
                <li className="list-disc text-2xl  ml-4 mb-1">
                  {question.text}
                </li>
                  ...
                  {[...Array(10)].map((_, i) => {
                    ...
                    return (
                      <button
                        ...
                        onClick={() =>
                          handleAnswer(
                            feedbackQuestions.indexOf(question),
                            value
                          )
                        }
                      >
