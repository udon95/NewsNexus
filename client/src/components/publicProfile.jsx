...
return (
  <div className="min-h-screen bg-[#F9FAFB] text-gray-900">
    ...
    <main className="w-full bg-white text-gray-900">
      ...
      <div className="w-full bg-white border-b py-10 px-4 sm:px-8">
        <div className="max-w-5xl mx-auto flex flex-col sm:flex-row items-start gap-6">
          ...
          <div className="flex-1">
            ...
            <div className="text-sm text-gray-700 space-y-1">
              ...
              <p><span className="font-medium">Views:</span> {profileData.totalViews}</p>
              {expertTopics?.length > 0 && (
                <p><span className="font-medium">Expertise in:</span> {expertTopics.map(t => t.name).join(", ")}</p>
              )}
            </div>
          </div>
        </div>
      ...
      {/* Articles Section */}
      <div className="w-full py-10 px-4 sm:px-8 bg-white border-t">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-xl font-semibold mb-4">Articles</h2>
          {articles.length === 0 ? (
            <p className="text-gray-500 italic">No articles published yet.</p>
