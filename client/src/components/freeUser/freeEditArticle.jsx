  ...
  const handlePostArticle = async () => {
    ...
    if (articleStatus === "Draft") {
      if (monthlyPostCount >= 4) {
        alert(
          "You’ve reached your monthly limit of 4 published articles. Upgrade to Premium for unlimited posts."
        );
        return;
      }
                ...
                <>
                  ...
                  >
                    <EditorContent
                      ...
                      onClick={() =>
                        articleStatus === "Draft" && editor.commands.focus()
                      }
                    />
                  </div>
