      ...
      <div className="w-full max-w-4xl space-y-6">
        ...
        {selectedItem && article && (
          <div className="bg-white rounded-xl shadow border border-gray-200 p-6 space-y-4">
            ...
            <div className="bg-gray-100 rounded-xl shadow p-4 text-sm">
              <div className="font-bold mb-1">Article Text:</div>
        ...
        <div className="flex items-center justify-between">
          <h2 className="text-2xl font-semibold">Room Article Reports:</h2>
          <select
            id="status"
            name="status"
        ...
        <div className="bg-white rounded-xl shadow border border-gray-200 px-6 py-4 overflow-x-auto w-full">
          {displayedRows.length > 0 ? (
                ...
                {displayedRows.map((row, index) => (
                  ...
                  >
                    ...
                    <td className="px-4 py-2">
                      {articles.find((art) => art.postid === row.target_id)?.title || "Unknown"}
                    </td>
                  </tr>
                ))}
              </tbody>
            ...
            <p className="text-sm text-gray-600 italic">No room article reports yet.</p>
          )}
        </div>
      </div>
    </div>
...
export default AdminRoomArticleReports;
