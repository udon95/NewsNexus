...
const AdminProfile = () => {
  ...
  const updateUserEmail = async () => {
    ...
    if (error) {
      ...
      alert('Email update initiated. Please check your new email to confirm the change.');
    }
  };
  ...
  if (!user) return <p className="ml-10 mt-10 text-lg">Loading or not authenticated...</p>;
