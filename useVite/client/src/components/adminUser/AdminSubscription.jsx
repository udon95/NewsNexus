...
const AdminSubscription = () => {
    ...
    const fetchData = async () => {
      ...
      if (!error && data) {
        ...
        if (premium) {
          ...
          const isPromoActive = premium.promotion_active && premium.promotion_end_date >= today;
  ...
  const handleUpdate = async (tier) => {
    if (tier === "Free") {
      ...
      await supabase.from("subscriptions").update(updateData).eq("tier", "Premium");
    }
    alert("Updated successfully");
  };
        ...
        <div className="flex-1 px-32 py-14 font-grotesk">
          ...
          <div className="relative w-full max-w-[1180px]">
            <div className="flex items-center gap-4 mb-4">
              <label className="text-base text-gray-800 font-semibold whitespace-nowrap">Default Price :</label>
            ...
            <div className="flex flex-wrap gap-4 items-end mb-4">
              <div className="flex-1 min-w-[200px]">
                <label className="block text-sm text-gray-700 mb-1">Promotion Price:</label>
                <input
                  type="text"
                  placeholder="$..."
              ...
              <div className="flex-1 min-w-[200px]">
                <label className="block text-sm text-gray-700 mb-1">Promotion End Date:</label>
                <input
                  type="date"
