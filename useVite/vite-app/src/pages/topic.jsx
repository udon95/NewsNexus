...
import TopicList from "../components/topicList";
  ...
  return (
    ...
    >
      ...
      <main className="flex flex-col flex-grow items-left justify-center w-full max-w-[900px] mx-auto py-10 px-6 sm:px-6">
        <h1 className="text-4xl font-grotesk font-semibold text-left mb-5">
          Topic Interests:
        </h1>{" "}
        {showError && (
