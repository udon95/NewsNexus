...
const AdminUsers = () => {
  ...
  useEffect(() => {
    setFilteredUsers(rows.filter((row) => displayedUserTypes==="Free"? freeUserList.some(user => user.userid === row.userid):
                                          displayedUserTypes==="Premium"? premiumUserList.some(user => user.userid === row.userid):
                                          displayedUserTypes==="Expert"? expertUserList.some(user => user.username === row.username): row
                                          ));
